...
const BONUS_SLOTS = [
  ...
  },
  {
    ...
    help: 'Даёт один накапливаемый заряд смещения на соседнюю линию. Заряды можно копить и тратить позже.',
    cooldownMs: 0
  },
  {
    id: 'powerSwing',
    bonusLabel: 'Сильный рывок',
    help: 'Даёт один накопительный заряд сильного рывка. На клавиатуре расходуется через Shift+A / Shift+D даже поверх открытого вопроса.',
    cooldownMs: 0
  },
  {
    id: 'snowShield',
